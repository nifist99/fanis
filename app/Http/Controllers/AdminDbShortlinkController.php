<?php namespace App\Http\Controllers;
	...
	class AdminDbShortlinkController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Username","name"=>"username","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			...
			//$this->form[] = ["label"=>"Nama Shortlink","name"=>"nama_shortlink","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			//$this->form[] = ["label"=>"Api","name"=>"api","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
